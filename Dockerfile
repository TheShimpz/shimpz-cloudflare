...
WORKDIR /opt/shimpz-cloudflare
RUN install -d -o 10001 -g 10001 -m 0555 /opt/shimpz-cloudflare/assistant /opt/shimpz-cloudflare/help
...
ENV HOST=0.0.0.0 \
    PORT=8080 \
    PYTHONPATH=/opt/shimpz-cloudflare \
